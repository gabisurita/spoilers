#![feature(plugin, decl_macro, type_ascription, custom_attribute, concat_idents)]
...
create_endpoint!("/", events_create, events, Event, EventForm);
list_endpoint!("/", events_list, events, Event);
...
fn main() {
    let server = rocket::ignite()
        .mount("/", routes![events_create, events_list])
